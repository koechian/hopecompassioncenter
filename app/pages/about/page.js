  ...
  return (
    <div className="bg-brown relative flex flex-col justify-center items-center">
      <section className="w-full bg-cream py-10 desktop:py-20 gap-10 flex flex-col justify-center items-center">
        ...
        <p className="text-brown opacity-75 desktop:pb-20 w-[85%] mobile:w-1/2 text-center text-sm mobile:text-md">
      ...
      <img
        src="/hcc_banner.png"
        className="w-full tablet:w-3/4 tablet:-translate-y-20  opacity-1"
        alt=""
      />
        ...
        <div className="flex flex-col tablet:flex-row w-full gap-4 justify-between">
          <div className="flex flex-col justify-start desktop:justify-between gap-5 w-full tablet:w-5/12">
            ...
            <div className="flex flex-col w-full">
              ...
              <p className="text-cream text-sm font-light desktop:font-normal tablet:text-base">
                To realize an inspired, empowered and transformed community.
              </p>
            </div>
            <div className="flex flex-col w-full">
              <h4 className="text-orange text-xl desktop:text-2xl">
              ...
              <p className="text-cream text-sm font-light desktop:font-normal tablet:text-base">
                To reach out to vulnerable children, the elderly, women and the
                youth through education, mentorship, empowerment initiatives and
                outreach programs to realize a better community
              </p>
            </div>
          </div>

          <div className="flex flex-col bg-cream shadow-md rounded h-fit py-5 gap-3 px-4 tablet:px-10 w-full tablet:w-1/2">
            <h3 className="text-xl tablet:text-3xl font-semibold text-brown">
              "We aim to improve the outlook of communities in Mathare to help
              them see that there is better in the world. Better than the local
              optimum"
            </h3>
            <p className="text-sm tablet:text-base">
              At Hope Center, we work diligently and sincerely to improve our
              community by working together to help those who are in need. We
              aspire to inspire more people to join us in this movement. Our
              teams have cultivated a culture that entails:
            </p>
            ...
            <div className="flex flex-row justify-between items-baseline">
              <div className="flex flex-row gap-3">
                <img
                  src="/kevin.jpg"
                  className="object-top rounded-full h-[6vh] w-[6vh] bg-slate-400 object-cover"
                  alt=""
                />
                <div className="flex flex-col">
                  ...
                  <a
                    target="_blank"
                    href="https://www.facebook.com/kevin.otieno.33"
      ...
      <section className="flex flex-col w-full px-4 tablet:w-11/12 desktop:w-3/4 pt-0 desktop:pt-20">
        <div className="flex flex-col tablet:flex-row justify-between py-10 tablet:py-20">
          ...
          <div className="w-full py-5 tablet:py-0 tablet:w-5/12">
            <p className="font-light text-cream text-md ">
              From feeding over 200 children in Mathare to providing safe spaces
              for young minds, empowering the youth through skill development,
              and supporting elderly women in Migori, our impact resonates
              through transformative actions that span across generations.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-row relative justify-between">
          ...
          {buttons.map((btn, index) => (
            <button
              ...
              className={`ring-1 ring-orange ${
                selected >= index
                  ? "bg-orange text-cream "
                  : "bg-brown text-orange"
              } z-[2] w-2/12 hover:bg-orange_light hover:text-gray-300 hover:scale-105 transition-all ease-in-expo rounded-full tablet:rounded-full py-2 uppercase `}
            >
        ...
        <p className="w-full text-center text-gray-400 uppercase py-5 text-xl tablet:hidden">
          {buttons[selected]}
        </p>
        {sections[selected]}
      </section>
